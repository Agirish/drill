...
public class JSONRecordReader extends AbstractRecordReader {
  ...
  public JSONRecordReader(FragmentContext fragmentContext, String inputPath, DrillFileSystem fileSystem,
    ...
    this.allNumeralsAsDoubleMode = fragmentContext.getOptions().getOption(ExecConstants.JSON_ALL_NUMERALS_AS_DOUBLE_MODE).bool_val;
  }
  ...
  public void setup(OutputMutator output) throws ExecutionSetupException {
    try{
      ...
      this.mutator = output;
      this.jsonReader = new JsonReader(fragmentContext.getManagedBuffer(), columns, enableAllTextMode, allNumeralsAsDoubleMode);
